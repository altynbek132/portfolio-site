...
## Stylelinting in VScode

install [stylelint](https://marketplace.visualstudio.com/items?itemName=stylelint.vscode-stylelint) extension in vscode
...
```json
{
  "browserslist": ["last 3 versions", "> 0.5%"]
}
```
